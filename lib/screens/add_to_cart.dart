...
class AddToCart extends StatelessWidget {
  ...
  const AddToCart({Key? key, required this.productsModel}) : super(key: key);
...
class AddCartView extends StatefulWidget {
  final ProductsModel productsModel;
  const AddCartView({Key? key, required this.productsModel}) : super(key: key);
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: inActiveColor.withOpacity(.3))),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Expanded(
